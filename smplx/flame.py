...
from .utils import Struct, rot_mat_to_euler, to_np, to_tensor
...
class FLAME(nn.Module):
    ...
    def __init__(self, 
        ...
        flame_model_path = model_path   
        model_dir = os.path.dirname(flame_model_path)
        static_landmark_embedding_path = f'{model_dir}/flame_static_embedding.pkl'
        dynamic_landmark_embedding_path = f'{model_dir}/flame_dynamic_embedding.npy'
        ...
        default_exp = torch.zeros(
            [self.batch_size, 100 - num_expression_coeffs],
            dtype=self.dtype,
            requires_grad=False,
        )
        self.register_parameter(
        ...
        self.create_transl = create_transl
